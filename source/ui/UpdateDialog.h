...
public:
  UpdateDialog(const pupon::network::UpdateInfo& info,
  ...
  static UpdateDialog* ShowInComponent(const pupon::network::UpdateInfo& info,
                                       std::function<void()> onClose = {});
...
private:
  ...
  pupon::network::UpdateInfo info_;
